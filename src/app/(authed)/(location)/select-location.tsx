import {
	...
	ScrollView,  // Agregamos ScrollView para mayor control en la vista
  } from "react-native";
  import React, { useEffect } from "react";
  import MapView, { Marker, PROVIDER_DEFAULT } from "react-native-maps"; // Usa PROVIDER_GOOGLE solo para Android
  ...
  export default function SelectLocation() {
	...
	return (
	  <KeyboardAvoidingView
		...
		behavior={Platform.OS === "ios" ? "padding" : "height"} // Cambia según la plataforma
		keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} // Ajusta el offset para iOS
	  >
		<TouchableOpacity
		  onPress={() => router.back()}
		  activeOpacity={0.8}
		...
		{/* ScrollView envuelve todo para controlar mejor el desplazamiento */}
		<ScrollView contentContainerStyle={tw`flex-1`} keyboardShouldPersistTaps="handled">
		  {/* MapView para ambos, Android e iOS */}
		  <MapView
